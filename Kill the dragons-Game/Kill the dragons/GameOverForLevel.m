...
-(void)goToGameScene {
    ...
    NSInteger playerHealht = [[MapScene sharedInstance] givePlayerHealth];
    SKScene * gameScene = [[GameScene alloc] initWithSize:self.size andPlayerHealth: playerHealht andEnemies:[[MapScene sharedInstance] enemiesInfo]];
